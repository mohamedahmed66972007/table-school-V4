...
export async function exportTeacherSchedulePDF(
  ...
  autoTable(doc, {
    ...
    columnStyles: {
      7: { halign: "right", fontStyle: "normal", fontSize: options.dayFontSize, font: fonts.day, textColor: options.dayFontColor },
    },
...
export async function exportClassSchedulePDF(
  ...
  autoTable(doc, {
    ...
    columnStyles: {
      7: { halign: "right", fontStyle: "normal", fontSize: options.dayFontSize, font: fonts.day, textColor: options.dayTextColor },
    },
    margin: { left: 15, right: 15 },
    tableWidth: 'auto',
  });
  ...
  for (let grade = 10; grade <= 12; grade++) {
    for (let section = 1; section <= 8; section++) {
      ...
      autoTable(doc, {
        ...
        columnStyles: {
          7: { font: fonts.day, fontSize: options.dayFontSize, textColor: options.dayFontColor, halign: "right" },
        },
        margin: { left: 12, right: 12 },
        tableWidth: 'auto',
      });
